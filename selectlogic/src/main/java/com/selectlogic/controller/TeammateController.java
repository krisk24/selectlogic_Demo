...
public class TeammateController {
	...
	public ModelAndView getTeammates() {
		...
		.addObject("teammates",
				StreamSupport.stream(teammateRepository.
		...
		.addObject("postLink",
				linkTo(methodOn(TeammateController.class)
				.newTeammate(null))
				.withRel("Create"))
	...
	public ModelAndView newTeammate(@ModelAttribute Teammate
	teammate) {
